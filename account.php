    ...
    <?php if(!isset($_SESSION['Logged_In'])) {
            ...
            <div class="info">
                    ...
                    <?php
                        ...
                        $count = 0;
                    ?>
                    <div class="info-title"><span>My payslip(s):</span></div>
                    <div class="info-row">
                    ...
                    <div class="info-title"><span>My account details:</span></div>
                        <div class="info-row">
                    ...
                    <div class="info-title"><span>Make a request:</span></div>
                    <form action="account.php" method="POST">
                        <div class="info-row">
                            ...
                            <label for="message"><span class="login-error"><?php echo $ME; ?></span>
                    ...
                    <!-- form for making time off requests -->
                    <!-- display available dates to book from availableDays table -->
                    <div class="info-title"><span>Book time off work:</span></div>
                    <form action="account.php" method="POST">
                        <?php
            ...
            <!-- if user type is newHire, display training tasks in navbar and here -->
            <?php
                if($_SESSION['Type'] == "newHire") {
            ?>
                <div class="info">
                    <div class="info-title"><span>My task(s):</span></div>
                    <div class="info-row">
